...
class LuzonActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsL.USER_NAME)
        mQuestionsList = ConstantsL.getQuestions()
                ...
                if(mSelectedOptionPosition == 0){
                    ...
                    when{
                        mCurrentPosition <= mQuestionsList!!.size ->{
                            ...
                            intent.putExtra(ConstantsL.USER_NAME, mUserName)
