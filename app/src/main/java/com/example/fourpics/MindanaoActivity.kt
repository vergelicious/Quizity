...
class MindanaoActivity : AppCompatActivity(), View.OnClickListener {
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<MindanaoQuestions>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsM.USER_NAME)
        mQuestionsList = ConstantsM.getQuestionsM()
                ...
                if(mSelectedOptionPosition == 0){
                    ...
                    when{
                        mCurrentPosition <= mQuestionsList!!.size ->{
                            ...
                            intent.putExtra(ConstantsM.USER_NAME, mUserName)
                            intent.putExtra(ConstantsM.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(ConstantsM.TOTAL_QUESTIONS, mQuestionsList!!.size)
